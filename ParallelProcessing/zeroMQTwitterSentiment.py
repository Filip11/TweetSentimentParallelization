...
class TwitterClient(object):
    ...
    def __init__(self):
        ...
        consumer_key = 'C2bZsbun433sCmv772WpNr27J'
        consumer_secret = 'Fj05iaHu3Y1H2aX6gUx3IOlOHnlDKzRwNpJ2h1BaOABLRDydFz'
        access_token = '937767439252836352-k4uGS5d0QEbAfw0AkenNZpcDWhr15wg'
        access_token_secret = ' 4l3QG31vVPhoL90pmpKSRz8KIhaJje3Qn0G4EojJM7DCA'
    ...
    def parse_tweets(self, fetched_tweets,core):
        ...
        '''
        zmq_pullsocket = context.socket(zmq.PULL)
        zmq_pullsocket.bind("tcp://0.0.0.0:5557")
        message = zmq_pullsocket.recv()
        print(message)
        '''
...
def worker(core, tweet_limit, fetched_tweets):
    ...
    zmq_pushsocket.connect("tcp://0.0.0.0:5557")

    zmq_pushsocket.send_string("MESSAGE")
    '''
